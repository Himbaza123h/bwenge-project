      ...
      <div className="row">
        ...
        <div className="usefulink ">
          ...
          <div className="col-md-2 mt-4 sm-ms-3 ">
            ...
            <h3>Useful Links</h3>
            <div className="mt-3"
            // onClick={(e) => history.push("/introduction")}
            >
              <FcNext /> Home
            </div>
            <div className="mt-3"
            // onClick={(e) => history.push("/mission")}
            >
              <FcNext /> Mission
            </div>
            <div className="mt-3"
            // onClick={(e) => history.push("/bwengeservices")}
            >
              <FcNext />Services
            </div>
            <div className="mt-3"
            // onClick={(e) => history.push("/nsangizadescription")}
            >
              <FcNext /> Nsangiza
            </div>
          ...
          <div className="col-md-2 mt-4">
            <h3>Partners</h3>
            <div className="mt-3"
            // onClick={(e) => history.push("/applypartner")}
            >
              <FcNext /> Apply for partnership
            </div>
            <div className="mt-3"
            // onClick={(e) => history.push("/applyorgnpartner")}
            >
        ...
        <div className="media">
          <div className=" socialmedia">
            ...
            />
            <FaTwitter
              // onClick={(e) => history.push("https://twitter.com/Bwenge_RLC")} 
              className="img-fluid socialmedialinks mt-2"
              size={30}
            />
            <FaInstagram
